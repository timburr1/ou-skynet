...
void ObserverManager::executeMicro(const UnitVector & targets, BWAPI::Position regroup) 
{
	...
	{
		BWAPI::Unit * closestCloaked = closestCloakedUnit(cloakedUnits, observer);
		...
		{
			BWAPI::Position explorePosition = MapGrid::getInstance()->getLeastExplored();
